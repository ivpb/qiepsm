...
class QiBertEmbedder(nn.Module):
    def __init__(self, pretrained_model_name,fine_tune_layers):
        ...
        self.dims = [[[512,640],[640,768]],[[384,512],[512,640]],[[256,384],[384,512]],[[128,256],[256,384]],[[0,128],[128,256]],[0,128]]
    ...
    def get_description(self):
        return f"Model: qi-bert (adj), Pretrained Model: {self.pretrained_model_name}, Fine Tune Layers: {self.fine_tune_layers}, Qi Head: U+CU(128)"
