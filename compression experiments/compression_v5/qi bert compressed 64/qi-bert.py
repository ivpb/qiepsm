...
class QiBertEmbedder(nn.Module):
    def __init__(self, pretrained_model_name,fine_tune_layers):
        ...
        self.dims = [[[640,704],[704,768]],[[576,640],[640,704]],[[512,576],[576,640]],[[448,512],[512,576]],[[384,448],[448,512]],[[320,384],[384,448]],[[256,320],[320,384]],[[192,256],[256,320]],[[128,192],[192,256]],[[64,128],[128,192]],[[0,64],[64,128]],[0,64]]
    ...
    def get_description(self):
        return f"Model: qi-bert (adj), Pretrained Model: {self.pretrained_model_name}, Fine Tune Layers: {self.fine_tune_layers}, Qi Head: U+CU(64)"
