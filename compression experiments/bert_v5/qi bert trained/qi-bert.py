...
from bert_v5.common import DEVICE_IDS, run_evaluation, PRETRAINED_MODEL_NAME, FINE_TUNE_LAYERS, trec19_loader, trec20_loader
...
def evaluator_score_fn(model,question_passage_bert_batch, _):
    ...
    return fidelity(output[:1],output[1:])
