...
class QiBertEmbedder(nn.Module):
    ...
    def get_description(self):
        return f"Model: qi-bert (adj), Pretrained Model: {self.pretrained_model_name}, Fine Tune Layers: {self.fine_tune_layers}, Qi Head: U+CU"
...
def start_run(run, train_val_fraction):
    run_evaluation(execute, run, train_val_fraction)
